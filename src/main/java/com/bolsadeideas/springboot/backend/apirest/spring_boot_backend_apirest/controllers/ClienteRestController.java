package com.bolsadeideas.springboot.backend.apirest.spring_boot_backend_apirest.controllers;
...
public class ClienteRestController {
    ...
    public ResponseEntity<?> save(@Valid @RequestBody Cliente cliente, BindingResult result) {
        // cliente.setCreateAt(new Date()); Se está asignando la fecha en el Entity
    ...
    public ResponseEntity<?> deleteById(@PathVariable Long id) {
        ...
        try {
            ...
            uploadService.eliminarImagen(nombreFotoAnterior);
